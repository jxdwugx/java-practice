...
public class DBConnectionManager {
    ...
    public static final String INSERT_USER_DML_SQL_TEST =
...
//            user.setPhoneNumber(resultSet.getString("phoneNumber"));
    ...
    protected static <T> T executeQuery(Connection connection, String sql, ThrowableFunction<ResultSet, T> function,
    ...
    protected static boolean execute(Connection connection, String sql,
                                        Consumer<Throwable> exceptionHandler, Object... args) {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            for (int i = 0; i < args.length; i++) {
